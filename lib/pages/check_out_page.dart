...
//           future: context.read<ProductProvider>().productService.fetchOneProduct(id: id),
...
//             } else {
//               List cartItems = productProvider.checkout;
...
//                       itemCount: productProvider.checkout.length,
...
//                                     ElevatedButton(
//                                       onPressed: () {
//                                        var x= productProvider.getTotalPrice();
//                                        print(x);
//                                       },
//                                       style: ElevatedButton.styleFrom(
